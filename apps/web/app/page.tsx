    ...
    <main className="min-h-screen bg-gray-950 text-white flex flex-col">
      ...
      <section className="flex flex-col items-center justify-center text-center px-6 pt-24 pb-16 max-w-3xl mx-auto w-full">
        <div className="inline-flex items-center gap-2 bg-blue-950 border border-blue-800 rounded-full px-4 py-1.5 text-xs text-blue-300 font-medium mb-8">
          ...
          Live on Scroll L2 · XRPL · Constitutional Registry
        </div>
        ...
        <p className="text-gray-500 text-lg mb-10">
          CMRAi fixes that. One constitutional verification ties every agent you deploy back to you — permanently, on-chain.
        </p>
      ...
      <section className="border-t border-gray-900 px-6 py-16">
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-green-950/30 border border-green-900/50 rounded-2xl p-6">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">CMRAi issues a Human Origin Confirmation (HOC) — a cryptographic proof that binds your verified identity to every agent you register. Anchored on Scroll L2. Permanent.</p>
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-gray-900 px-6 py-16">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col gap-4">
            {[
              { step: '01', title: 'Verify your identity', desc: 'Live video, government ID, and constitutional oath — witnessed by AI. Takes 3 minutes.' },
              { step: '02', title: 'Receive your HOC', desc: 'Your Human Origin Confirmation is anchored on Scroll L2. Your CMID is minted on XRPL. Delivered to Telegram instantly.' },
      ...
      <section className="border-t border-gray-900 px-6 py-16">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {['Scroll L2', 'XRPL', 'ElevenLabs', 'Pinata IPFS', 'NIST AI RMF', 'ChainMail MMCP'].map((tech) => (
